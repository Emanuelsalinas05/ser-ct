          ...
          <tr>
            <td style="padding:0 24px 16px 24px;font:14px 'Segoe UI',Arial,Helvetica,sans-serif;color:#333;">
              <div style="background:#e8f5e8;border:1px solid #4caf50;border-radius:8px;padding:16px;">
                <div style="font-weight:700;color:#2e7d32;margin-bottom:8px;">✅ APROBADO POR DEPARTAMENTO</div>
                <div>El certificado de no adeudo ha sido aprobado por el Departamento correspondiente y está listo para continuar con el proceso de escalamiento jerárquico.</div>
              </div>
            </td>
          </tr>
