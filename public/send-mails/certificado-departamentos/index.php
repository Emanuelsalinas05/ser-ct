...
require __DIR__ . '/../../PHPMailer/class.smtp.php';
    ...
    $mail->SMTPSecure = "tls";
    $mail->SMTPAuth   = true;
    $mail->Username   = "entregasrecepcion.departamentos@seiem.edu.mx";
...
$mail->setFrom('entregasrecepcion.departamentos@seiem.edu.mx', "Notificación de Certificado No Adeudo | {$elct}");
...
$mail->isHTML(true);
$mail->Subject = 'Notificación de Certificado de No Adeudo - Aprobado por Departamento';
            ...
            if (!$mysqli->connect_errno) {
                ...
                $stmt = $mysqli->prepare(
                    "UPDATE g1solicitudes_noadeudos
                     SET oenviado = 1, oaprobado_departamento = 1
