<?php 
          ...
          $message .=utf8_decode('Se notifica por este medio la intervención en el proceso para la entrega-recepción del Centro de Trabajo: ');
          ...
          $mail->Subject = utf8_decode("(CORREO PRUEBA 2.0) NOTIFICACIÓN PARA INTERVENCIÓN DE E-R ");
          $mail->Body    = $message;
