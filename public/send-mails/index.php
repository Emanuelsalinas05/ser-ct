...
*/
    ...
    $ocorreocc  = $datosacta->ocorreocc;
    $elmail1 = $datosacta->ocorreocc;
    ...
    $linkcarpeta= 'https://entregasrecepcion.seiem.gob.mx/'.$datosacta->ourlcarpeta.$datosacta->onombrecarpeta;
...
if($datosacta->oenviocorreooic==0)   
{
    ...
    $mail->FromName = utf8_decode("CARPETA DE ENTREGA Y RECEPCIÓN DEL CCT ".$elct);
