            ...
            $ct = CentrosTrabajo::whereKcvect(Auth::user()->id_ct)->first();
                ...
                if($request->acta_tipo=='1')
                {
                        $validatedData = $request->validate([
                                ...
                                'oidentificacion_entrega_a.required'    => 'SELECCIONA EL TIPO DE IDENTIFICACIÓN',
                                'onumero_identificacion_entrega_a.required'    => 'INGRESA EL NÚMERO DE IDENTIFICACIÓN',
                                'oidentificacion_url_entrega_a.required'=> 'SELECCIONA EL ARCHIVO A SUBIR',
                                'oidentificacion_recibe_a.required'     => 'SELECCIONA EL TIPO DE IDENTIFICACIÓN',
                                'onumero_identificacion_recibe_a.required'    => 'INGRESA EL NÚMERO DE IDENTIFICACIÓN',
                                ...
                                'orepresentante_a.required'  => 'SELECCIONA SI HAY REPRESENTANTE DE OIC O SECOGEM',
                                'oidentificacion_testigo.required'      => 'SELECCIONA EL TIPO DE IDENTIFICACIÓN PARA EL TESTIGO 1',
                                'oidentificacion_url_testigo.required'  => 'SELECCIONA EL ARCHIVO DE IDENTIFICACIÓN TESTIGO 1',
                                'onumero_identificacion_testigo_a.required'    => 'INGRESA EL NÚMERO DE IDENTIFICACIÓN DEL TESTIGO 1',
                                ...
                                'onumero_identificacion_testigo2_a.required'    => 'INGRESA EL NÚMERO DE IDENTIFICACIÓN DEL TESTIGO 2',
                                'oidentificacion_url_testigo2.required' => 'SELECCIONA EL ARCHIVO DE IDENTIFICACIÓN TESTIGO 2',
                        ...
                        $validatedData = $request->validate([
                                ...
                                'otelefono_ct_ac.required'               => 'REGISTRA EL TELÉFONO',
                                'odepartamento_ac.required'              => 'INGRESA EL NOMBRE DEL DEPARTAMENTO',
                                'oidentificacion_recibe_ac.required'     => 'SELECCIONA EL TIPO DE IDENTIFICACIÓN',
                                ...
                                'oidentificacion_testigo1_ac.required'   => 'SELECCIONA EL TIPO DE IDENTIFICACIÓN',
                                'onumero_identificacion_recibe_ac.required'=> 'INGRESA EL NÚMERO DE IDENTIFICACIÓN',
                                'onumero_identificacion_testigo1_ac.required'=> 'INGRESA EL NÚMERO DE IDENTIFICACIÓN DEL TESTIGO 1',
                                'onumero_identificacion_testigo2_ac.required'=> 'INGRESA EL NÚMERO DE IDENTIFICACIÓN DEL TESTIGO 2',
                                ...
                                'oidentificacion_testigo2_ac.required'   => 'SELECCIONA EL TIPO DE IDENTIFICACIÓN',
                                ...
                                'ohora_fin_ac.required'     => 'INGRESE LA HORA DE TERMINO',
                                'ofecha_fin_ac.required'    =>  'INGRESE LA FECHA DE TERMINO',
                        ]);
