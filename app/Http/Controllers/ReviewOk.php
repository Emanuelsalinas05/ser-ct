...
class ReviewOk extends Controller
{
    ...
    public function marcjuridico($id)
    {
        ...
        $juridicos  = Ordenamientojuridico::whereIdCt($datosacta->id_ct)->whereNotIn('status', ['B'])->OrderBy('id', 'ASC')->get();
    ...
    public function rhumanos($id)
    {
        ...
        $datosacta  = DatosActa::whereId($id)->first();                             // F
        $avance     = Avanceanexos::whereIdActa($datosacta->id)->first();           // F
        $plantillap = Plantillapersonal::whereIdActa($datosacta->id)->whereNotIn('status', ['B'])->get();          
    ...
    public function situaciontics($id)
    {
        ...
        $documentos = Documentos::whereIdAnexo($anexo->id)->get();
        $datosacta  = DatosActa::whereId($id)->first();                                 // F
        $avance     = Avanceanexos::whereIdActa($datosacta->id)->whereNotIn('status', ['B'])->first();               // F
