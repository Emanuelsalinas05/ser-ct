...
class _xEstructuractController extends Controller
{
    ...
    {
            $supervision = Organitation::whereOdireccionnivel('DIRECCION DE EDUCACION ELEMENTAL')
                            ->whereCctSupervision($id)->get();

            return view('_estructura.edit', 
                compact('supervision')
                    );
    }
