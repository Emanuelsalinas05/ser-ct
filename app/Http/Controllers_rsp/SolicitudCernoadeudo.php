...
class SolicitudCernoadeudo extends Controller
{
    ...
    public function index()
    {
        ...
        $solicitudc = Solicitudnoadeudo::whereIdActa($datosacta->id)->whereOselecttipo(1)->count();
        $solicitud  = Solicitudnoadeudo::whereIdActa($datosacta->id)->whereOselecttipo(1)->first();
