...
return new class extends Migration
{
    ...
    {
        Schema::create('g1archivos_concentracion_historico', function (Blueprint $table) {
            ...
            $table->string('operiodo')->nullable(true);
            $table->Integer('onum_legajos')->default(0);
            $table->Integer('onum_documentos')->default(0);
            $table->string('otiempo_conservacion')->nullable(true);
            $table->longText('ocomentarios')->nullable(true);
    ...
    {
        Schema::dropIfExists('g1archivos_concentracion_historico');
    }
};
