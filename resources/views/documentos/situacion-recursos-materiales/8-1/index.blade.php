...
@section('title', '8.1 INVENTARIO DE BIENES MUEBLES, INMUEBLES Y SEMOVIENTES')
@section('content_header_title', 'Home')
@section('content_header_subtitle', ' 8.1 INVENTARIO DE BIENES MUEBLES, INMUEBLES Y SEMOVIENTES')
...
<div class="col-12 card card-secondary card-outline shadow" >
    ...
    <div class="card-body table-responsive" >
        ...
        <br>
        @if($avances->oinventario_bienes_a==0)
            ...
            <br>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center"
                    ...
                    <form   name="FrmCartel" id="FrmCartel" method="post" 
                            action="{{ route('inventario-bienes.update', $datosacta->id ) }}" >
                            @method('PATCH')
                            @csrf
                        <input  type="hidden" 
                                name="acta" 
