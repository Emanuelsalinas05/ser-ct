...
@section('title', '13.1 RELACIÓN DE ARCHIVOS EN TRÁMITE')
@section('content_header_title', 'Home')
@section('content_header_subtitle', ' 13.1 RELACIÓN DE ARCHIVOS EN TRÁMITE')
...
<div class="col-12 card card-secondary card-outline shadow" >
    ...
    <div class="card-body table-responsive" >
        ...
        @if($avances->orelacion_archivos_a==0)
            <x-adminlte-callout>
                    @include('documentos.archivos.13-1.form-carga')
            </x-adminlte-callout>
        @endif

        @if($iarchivosc>0)

            @include('documentos.archivos.13-1.list-files')           
            <br>
            @if($avances->orelacion_archivos_a==0)
