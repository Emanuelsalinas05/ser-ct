<form   name="FrmCartel" id="FrmCartel" method="post" id="form1"
        ...
        <input  type="hidden" name="idacta" id="idacta"
                value="{{ $datosacta->id }}">
        <input  type="hidden" name="actiontic" id="actiontic"
                value="9">
...
<form   name="FrmCartel" id="FrmCartel" method="post" id="form2"
        action="{{ route($documento->ourl_documentos.'.store') }}" 
        enctype="multipart/form-data">
        @method('POST')
        @csrf
        ...
        <tbody>
            <tr>
                <td width="50%">
                    <input  type="text" 
                            name="onombre_documento" id="onombre_documento"
                            required 
