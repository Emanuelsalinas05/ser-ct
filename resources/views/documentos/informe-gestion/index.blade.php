...
@section('title', '15. INFORME DE GESTIÓN')
@section('content_header_title', 'Home')
@section('content_header_subtitle', ' 15. INFORME DE GESTIÓN')
        ...
        <x-adminlte-callout theme="info">
            <div class="row">
                <div class="col-sm">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            {{$documento->onum_documento}} ) {{$documento->odocumento}}
                                ...
                                @foreach($avanceanexos as $avance)
                                    ...
                                    @elseif($documento->oavance_documentos=='oinforme_compromisos_a')
                                        <a  href="{{ url($documento->ourl_documentos) }}"
                                            style="text-decoration: none; font-size:12px;" 
                                            class="btn bg-teal btn-outline-dark btn-sm ">
                                            @if($avance->oinforme_compromisos_a==1)
                                                Completado 
                                                <i class="fas fa-check"></i>      
                                            @else
                                                Registrar 
                    ...
                    @if($datosacta->avances->oinforme_gestion_a==1 && $datosacta->avances->oinforme_compromisos_a==1)
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        &nbsp;

                        @if($datosacta->avances->oinforme_gestion_d==1)
                            <a  href="{{ url('entrega-recepcion') }}" 
