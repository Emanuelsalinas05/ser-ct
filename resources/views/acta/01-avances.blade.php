<x-adminlte-callout title="NIVEL DE CUMPLIENTO DEL ACTO DE ENTREGA-RECEPCIÓN"
        ...
        <span style="font-size:13px; color: black; text-align: justify;">
            ...
            ** SELECCIONA Y DA CLIC, SOBRE EL NÚMERO DE ANEXO AL CUAL QUIERAS DIRIGIRTE.  
            <br>
            <ul>
                <li>
                ...
                <li class="text-warning">
                    <b>
                        PODRÁS REALIZAR EL CAMBIO ENTRE ANEXOS, SI ASÍ LO REQUIERES, SOLO DEBERÁS DE SOLICITAR LA APERTURA DEL MISMO A TU AUTORIDAD INMEDIATA SUPERIOR. TODO ESTO ANTES DE REGISTRAR LOS DATOS DEL ACTA, POSTERIOR A LLENAR LOS DATOS EN EL ACTA, NO PODRÁ TU SUPERIOR HABILITAR LA APERTURA DE UN ANEXO.
                </b>
                </li>
            </ul>
        </span>
            ...
            <tbody>
                ...
                <tr class="shadow-sm">
                    <td colspan="2">
                            @if($avance->oestado==1)
                                <!--
                                @if(Auth::user()->onivel=='SECUNDARIA') <b class="text-warning">1) DESCARGA </b>&nbsp;&nbsp;&nbsp;&nbsp; @endif
                                -->
