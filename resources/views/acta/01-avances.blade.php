   ...
   <span style="font-size:13px; color: black; text-align: justify;">
    ...
    <ul>
        ...
        <li class="text-warning">
          <b>
    UNA VEZ FINALIZADOS LOS ANEXOS, SOLO PODRÁN SER EDITADOS SI TU AUTORIDAD INMEDIATA SUPERIOR LOS HABILITA NUEVAMENTE.<br>
    ESTA ACCIÓN SOLO SERÁ POSIBLE ANTES DE LA APROBACIÓN DEL ACTA. POSTERIORMENTE, NO SE PODRÁ REALIZAR NINGUNA EDICIÓN SOBRE LOS ANEXOS.
        </b>
