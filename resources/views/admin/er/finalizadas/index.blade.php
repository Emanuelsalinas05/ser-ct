            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="15%" style="font-size:11px;">
                        <b>FECHA</b>: {{ $acta->id_tipoacta==1 ? $acta->ofecha_fin_a : $acta->ofecha_fin_ac }}
                        <br>
                        <b>HORA</b>:  {{ $acta->id_tipoacta==1 ? $acta->ohora_fin_a  : $acta->ohora_fin_ac }}
                    </td>
                    
                    <td width="10%" align="center">
                        <a  href="{{route('entregas-finalizadas.edit', $acta->idd)}}" 
