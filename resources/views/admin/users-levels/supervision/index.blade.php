...
@section('title', 'USUARIOS SUPERVISIÓN. REVISIÓN/APROBACIÓN DE ENTREGA-RECEPCIÓN')
@section('content_header_title', 'Home')
@section('content_header_subtitle', ' USUARIOS SUPERVISIÓN. REVISIÓN/APROBACIÓN DE ENTREGA-RECEPCIÓN')
    ...
    <div class="card-header bg-light shadow-sm d-flex mb-2">
        <div class="d-flex justify-content-between" style="font-size:13px;">
            <b><i class="nav-icon fa fa-users"></i>&nbsp;
                USUARIOS SUPERVISIÓN. REVISIÓN/APROBACIÓN DE ENTREGA-RECEPCIÓN
            </b> 
        </div>
    </div>
