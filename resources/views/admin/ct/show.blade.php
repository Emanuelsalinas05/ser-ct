...
@section('content')
    <div class="col-12 card card-secondary card-outline shadow">
        ...
        <div class="card-body table-responsive">
            ...
            @if(Auth::user()->orol == 1)
                <x-adminlte-callout>
                    <form name="FrmCartel" id="FrmCartel" method="GET" action="{{ route('centros-de-trabajo.show', 0) }}" class="row g-2 align-items-center">
                        @method('PATCH')
                        @csrf
                        <div class="col-md-3 text-end">
                            <label for="elct" class="col-form-label text-info fw-bold">Buscar centro de trabajo</label>
                        </div>
                        <div class="col-md-3">
                            <input type="text" id="elct" name="elct" class="form-control" required value="{{ old('elct', $requeste) }}">
                        </div>
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-outline-success btn-sm w-100">
                                <i class="fa fa-search"></i> Ver CT
                            </button>
                        </div>
                        <div class="col-md-3 text-end">
